...
from src.github_api import get_stargazers
import csv
...
def main(repo_url, max_stargazers=None, scrape_linkedin=False, use_agentops=False, use_mem0=False, use_neo4j_kg=False):
    ...
    # Step 1 and 2: Get stargazers and their details
    stargazers = get_stargazers(owner, repo, max_stargazers)
    ...
    print(f"Writing stargazers data to CSV. Number of GitHub users to write: {len(stargazers)}")
